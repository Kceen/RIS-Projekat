...
<body class="w3-content" style="max-width: 1200px">
	...
	<div class="w3-main" style="margin-left: 250px">
		...
		<div class="w3-display-container w3-container">
			<img
				src="https://www.pesmedia.com/wp-content/uploads/2019/10/Lotus-Evija-e1572537716839.jpg"
				 style="width: 100%">
			<div class="w3-display-topleft w3-text-white"
				style="padding: 24px 48px">
				<h1 class="w3-jumbo w3-hide-small"
					style="text-shadow: 2px 2px black;">Welcome to www.aukcinjo.com</h1>
				<h1 class="w3-hide-large w3-hide-medium"
					style="text-shadow: 2px 2px black;">Welcome to www.aukcinjo.com</h1>
				<h1 class="w3-hide-small" style="text-shadow: 2px 2px black;">The best auction site in the world</h1>
				<p>
		...
		<c:if test="${!empty bids}">
			<div class="w3-container w3-text-grey" id="jeans">
				<p> ${bids.size()} auctions available </p>
			</div>
				...
				<c:forEach items="${bids}" var="bid">
					<div class="w3-col l3 s6">
						<div class="w3-container">
							<a href="/Aukcinjo/auctionController/findBid?idBid=${bid.idBid}" style="text-decoration: none"> <img src="${bid.item.images.get(0).imageLink}"
								style="height: 150px"> </a>
							
							<p> <a href="/Aukcinjo/auctionController/findBid?idBid=${bid.idBid}" style="text-decoration: none"> ${bid.item.name} <br>
							<b> Current price: ${bid.currentPrice} € </b> <br>
							Starting price: ${bid.startingPrice} € </a> </p> 
						</div>
					</div>
				</c:forEach>
			...
			<a href="/Aukcinjo/auctionController/generateReport"> Generate a report with all auctions </a> <br><br>
