...
<body class="w3-content" style="max-width: 1200px">
	...
	<div class="w3-main" style="margin-left: 250px">
		...
		<div class="w3-display-container w3-container">
			<img
				src="https://jingtravel.com/wp-content/uploads/2019/04/charter-flight-compressor-1240x698.jpg"
				 style="width: 100%">
			<div class="w3-display-topleft w3-text-white"
				...
				<p>
					<a href="/Aukcinjo/serviceUserController/welcome"
						class="w3-button w3-white w3-padding-large w3-large" style="color: black">ENTER</a>
				</p>
			</div>
		</div>
