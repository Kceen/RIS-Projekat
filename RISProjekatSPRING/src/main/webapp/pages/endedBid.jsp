...
<body class="w3-content" style="max-width: 1200px">
	...
	<div class="w3-main" style="margin-left: 250px">
		...
		<h2> The winner is user: <a href="/Aukcinjo/serviceUserController/showUserDetails?idUser=${endedBid.serviceuser.idServiceUser}"> ${endedBid.serviceuser.username} </a> </h2>
		
		<h3> Auction starting price was ${endedBid.startingPrice} € </h3>
		<h3> Auction final price was <b> ${endedBid.currentPrice} € </b> </h3>
		<h3> Auction began on <fmt:formatDate value="${endedBid.startingDate}" pattern = "HH:mm - dd.MM.yyyy"/> </h3>
		<h3> Auction ended on <b> <fmt:formatDate value="${endedBid.endDate}" pattern = "HH:mm - dd.MM.yyyy"/> </b> </h3>
		
		<br><br>
		
		<p> Rate your experience with: ${endedBid.serviceuser.username} </p>
		<form action="/Aukcinjo/serviceUserController/rate?idSender=${loggedInUser.idServiceUser}&idReceiver=${endedBid.serviceuser.idServiceUser}" method="post">
			<input type="radio" name="rating" value="1" > EXCELLENT <br>
			<input type="radio" name="rating" value="0" > FINE <br>
			<input type="radio" name="rating" value="-1" > BAD <br>
