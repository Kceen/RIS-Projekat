...
<div class="w3-main" style="margin-left:250px">
  ...
  <header class="w3-container w3-xlarge">
    ...
    <p class="w3-right">
      <a href="/Aukcinjo/pages/register.jsp" style="text-decoration: none; margin-right: 10px"> REGISTER </a>
    </p>
  </header>

  
	<form action="/Aukcinjo/serviceUserController/loginUser" method="post">
		Username* <br>
